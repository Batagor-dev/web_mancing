...
class ProfilSecurityController extends Controller
{
    public function index()
    {
        $user = Auth::user();
        return view('profil_security.index', compact('user'));
    }
    ...
    public function store(UpdateAcountRequest $request)
    {
        ...
        $user->save();
         ...
         return redirect()->route('profil_security.store')->with('success', 'Profile berhasil diperbarui!');
    }

    public function security()
    {
        $user = Auth::user();
        return view('profil_security.security', compact('user'));
    }
    ...
    public function updatePassword(\App\Http\Requests\UpdatePasswordRequest $request)
    {
        ...
        return redirect()->route('profil_security.security')->with('success', 'Password berhasil diubah!');
    }
}